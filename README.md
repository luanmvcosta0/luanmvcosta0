...
[![My Skills](https://skillicons.dev/icons?i=js,ts,java,py,html,css,react,nextjs,vite,tailwind,styledcomponents,bun,spring,nodejs,nestjs,express,npm,flask,kafka,prisma,redis,aws,postgres,mysql,git,github,docker,selenium,jest,postman,figma,linux,vscode,idea,pycharm,notion&theme=light)](https://github.com/luanmvcosta0)
