...
[![My Skills](https://skillicons.dev/icons?i=js,ts,java,py,nodejs,nestjs,express,spring,fastapi,html,css,tailwind,react,nextjs,vite,styledcomponents,npm,bun,kafka,prisma,redis,aws,postgres,mysql,git,github,docker,selenium,jest,postman,md,figma,linux,vscode,idea,notion&theme=light)](https://github.com/luanmvcosta0)
