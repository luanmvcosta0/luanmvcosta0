...
[![My Skills](https://skillicons.dev/icons?i=js,ts,java,py,nodejs,nestjs,express,spring,flask,html,css,tailwind,react,nextjs,vite,styledcomponents,npm,bun,kafka,prisma,redis,aws,postgres,mysql,git,github,docker,selenium,jest,postman,figma,linux,vscode,idea,pycharm,notion&theme=light)](https://github.com/luanmvcosta0)
